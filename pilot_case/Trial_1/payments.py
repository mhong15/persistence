...
df = pd.read_csv('Exp1_Trial_1_cleaned_data.csv')
...
all_payments.to_csv('Exp1_Trial_1_payments.csv', index=False)
df.head(5).to_csv("Exp1_Trial_1_payments_test.csv", index=False)
