...
df = pd.read_csv('Exp2_Pilot_Case_cleaned_data.csv')
...
all_payments.to_csv('Exp2_Pilot_Case_payments.csv', index=False)
df.head(5).to_csv("Exp2_Pilot_Case_payments_test.csv", index=False)
