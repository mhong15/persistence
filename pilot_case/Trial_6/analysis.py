...
OTREE_DATA = "Exp1_Trial_6.csv"
DEMOGRAPHIC_DATA = "Exp1_Trial_6_Demographics.csv"
...
df.to_csv("Exp1_Trial_6_cleaned_data.csv")

# Print number of participants in the study
print(f'The number of participants in the Trial 6 is {df.shape[0]}')
...
df.to_csv("Exp1_Trial_6_analysis_data.csv")
