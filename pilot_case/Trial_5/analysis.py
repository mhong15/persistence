...
OTREE_DATA = "Exp1_Trial_5.csv"
DEMOGRAPHIC_DATA = "Exp1_Trial_5_Demographics.csv"
...
df.to_csv("Exp1_Trial_5_cleaned_data.csv")

# Print number of participants in the study
print(f'The number of participants in the Trial 5 is {df.shape[0]}')
...
df.to_csv("Exp1_Trial_5_analysis_data.csv")
